...
pickle.dump((x_data, y_data, sz_data, index.length()), open('data/data_train.pkl','wb'))
...
pickle.dump((x_data, y_data, sz_data, index.length()), open('data/data_val.pkl','wb'))
...
pickle.dump((x_data, y_data, sz_data, index.length()), open('data/data_test.pkl','wb'))
